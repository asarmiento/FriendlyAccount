...
Route::get('auth/restaurant', 'Auth\LoginController@getLoginRestaurant');
Route::post('auth/restaurant', ['as' => 'auth/restaurant', 'uses' => 'Auth\LoginController@postLoginRestaurant']);
...
Route::group(['prefix' => 'institucion'], function () {
    ...
    Route::group(['prefix' =>  'inst', 'middleware'=> 'userSchool'], function () {
        ...
        foreach($acountings AS $acounting):
            require __DIR__.'/Accounting/'.$acounting.'.php';
        endforeach;
        ...
        */
        ...
        foreach($educations AS $education):
            require __DIR__.'/Auxiliary/Education/Financial/'.$education.'.php';
        endforeach;
        ...
        foreach($auxSuppliers AS $auxSupplier):
            require __DIR__.'/Auxiliary/Supplier/'.$auxSupplier.'.php';
        endforeach;
        ...
        foreach($restaurants AS $restaurant):
            require __DIR__.'/Restaurant/'.$restaurant.'.php';
        endforeach;
        ...
        foreach($workshops AS $workshop):
            require __DIR__.'/Workshops/'.$workshop.'.php';
        endforeach;
        ...
        foreach($lawFirms AS $lawFirm):
            require __DIR__.'/LawFirms/'.$lawFirm.'.php';
        endforeach;
