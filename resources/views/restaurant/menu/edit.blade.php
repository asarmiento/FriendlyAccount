    ...
    <aside class="page">
        ...
        <div class="list-inline-block">
            <ul>
                ...
                <li class="active-page"><a>Editar Menu Restaurante</a></li>
            </ul>
        </div>
    </aside>
@endsection
    ...
    <div class="paddingWrapper">
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-mep">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nameMenuRestaurant" class="form-control" type="text" value="{{$menu->name}}" data-token="{{$menu->token}}">
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6">
                <div class="form-mep">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-tag"></i></span>
                        <input id="costoMenuRestaurant" class="form-control" type="text" value="{{$menu->costo}}">
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6">
                <div class="form-mep">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-tag"></i></span>
                        <select id="group_menu_idMenuRestaurant" class="form-control select2">
                            <option value="{{$menu->groupMenus->token}}">{{$menu->groupMenus->name}}</option>
        ...
        <section>
            <div class="row text-center">
                ...
                <a href="#" id="updateMenuRestaruants" data-url="menu-restaurante" class="btn btn-success">Grabar Menu Restaurante</a>
            </div>
        </section>
    </div>
@endsection
