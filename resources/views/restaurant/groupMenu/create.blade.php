    ...
    <aside class="page">
        ...
        <div class="list-inline-block">
            <ul>
                ...
                <li class="active-page"><a>Registrar Grupo de Menu del Restaurante</a></li>
            </ul>
        </div>
    </aside>
@endsection
    ...
    <div class="paddingWrapper">
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-mep">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nameGroupMenu" class="form-control" type="text">
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="row text-center">
                ...
                <a href="#" id="saveGroupMenu" data-url="grupo-de-menu" class="btn btn-success">Grabar Grudo de Menu</a>
            </div>
        </section>
    </div>
@endsection
