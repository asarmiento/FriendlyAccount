	...
	<div class="paddingWrapper">
		<section class="row">
			<div class="col-sm-6 col-md-6">
				<div class="form-mep">
					<label for="codeDegree">Nombre</label>
			...
			<div class="col-sm-6 col-md-6">
				<div class="form-mep">
					<label for="codeDegree">Familia de cuenta</label>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-barcode"></i></span>
			...
			<div class="col-sm-6 col-md-6">
				<div class="form-mep">
					<label for="codeDegree">Tipo de Cuenta</label>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-barcode"></i></span>
						<select>
							<option></option>
			...
			<div class="col-sm-6 col-md-6">
				<div class="form-mep">
					<label for="codeDegree">Cuenta Madre</label>
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-barcode"></i></span>
						<select>
