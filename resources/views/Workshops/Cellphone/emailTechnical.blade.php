...
<p>Hemos Terminar la reparación de su {{$messages->equipment}} el día de hoy, puede pasar por nuestro taller para retirarlo: </p>
<ul>
...
<p>------------------------------------------------------------------------------------------------------------------------------------------</p>
<p>Diagnostico: {{$technical->diagnosis}}</p>
<p>Trabajo realizado: {{$technical->work_done}}</p>
<p>Respuestos Utilizados: {{$technical->answer_used}}</p>
<p>Recomendaciones: {{$technical->recommendations}}</p>
<p>Costo Final: ₡ {{number_format($technical->final_cost,2)}}</p>
<p>------------------------------------------------------------------------------------------------------------------------------------------</p>
