	...
	<aside class="page"> 
		...
		<div class="list-inline-block">
			<ul>
				...
				<li class="active-page"><a>Editar Costo de Mensualidad</a></li>
			</ul>
		</div>
	</aside>
@endsection
...
@section('content')
	<div class="paddingWrapper">
				...
				<div class="form-mep">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				      	<input id="yearCost" class="form-control" type="number" maxlenght="4" value="{{ $cost->year }}" data-token="{{ $cost->token }}">
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-6">
				<div class="form-mep">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-usd"></i></span>
				      	<input id="monthlyPaymentCost" class="form-control" type="number" value="{{ $cost->monthly_payment }}">
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-6">
				<div class="form-mep">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-usd"></i></span>
				      	<input id="tuitionCost" class="form-control" type="number" value="{{ $cost->tuition }}">
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-6">
		...
		<div class="row text-center">
			...
			<a href="#" id="updateCost" data-url="costos" class="btn btn-success">Actualizar Costo de Mensualidad</a>
		</div>
	</div>
@endsection
